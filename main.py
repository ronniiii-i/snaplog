...
from src.config import LOCAL_SAVE_DIR, CONVERTED_DIR, NETWORK_BASE_PATH, CLIENT_CONFIG_FILE
...
def ensure_directories():
    ...
    try:
        ...
        logger.info(f"Local directories verified: {LOCAL_SAVE_DIR}, {CONVERTED_DIR}")
